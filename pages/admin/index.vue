    ...
    <div class="pt-32pt">
      ...
      >
        ...
        <div class="row" role="tablist">
          <div class="col-auto">
            <a href="instructor-earnings.html" class="btn btn-outline-secondary"
              >Earnings</a
            >
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div
              class="
                card
                border-1 border-left-3 border-left-accent
                text-center
                mb-lg-0
              "
            >
              ...
              <table class="table table-flush table-nowrap">
                ...
                <tbody class="list">
                  <tr>
                        ...
                        <div class="flex">
                          ...
                          <small class="text-muted mr-1">
                            ...
                            <a
                              ...
                              >#8734</a
                            >
                            - &dollar;<span class="js-lists-values-amount"
                              >89</span
                            >
                            USD
                          </small>
                    ...
                    <td class="text-right">
                      <small
                        class="text-muted text-uppercase js-lists-values-date"
                        >12 Nov 2018</small
                      >
                    </td>
                  </tr>
          ...
          <div class="card">
            <div class="card-body">
              <div class="media">
                <div class="media-left mr-12pt">
                  <a href="#" class="avatar avatar-sm">
                    <!-- <img src="/images/people/110/guy-9.jpg" alt="Guy" class="avatar-img rounded-circle"> -->
                ...
                <div class="media-body d-flex flex-column">
                  ...
                  <span class="text-muted"
                    ...
                    <a
                      ...
                      >Data Visualization With Chart.js</a
                    ></span
                  >
              ...
              >
                <div class="media-left mr-12pt">
                  <a href="#" class="avatar avatar-sm">
                    <!-- <img src="/images/people/110/guy-6.jpg" alt="Guy" class="avatar-img rounded-circle"> -->
                ...
                <div class="media-body">
                  ...
                  <p class="mt-1 mb-0 text-70">
                    Hi Bogdan,<br />
                    Thank you for purchasing our course! <br /><br />Please have
                    a look at the charts library documentation
                    <a href="#" class="text-underline">here</a> and follow the
                    instructions.
                  </p>
                </div>
              </div>
