  ...
  <div class="mdk-drawer-layout__content page-content">
    ...
    >
      ...
      <form
        ...
        action="https://luma.humatheme.com/Demos/Compact_App_Layout/index.html"
      >
      ...
      <a
        href="https://luma.humatheme.com/Demos/App_Layout/student-dashboard.html"
        class="
    ...
    <div class="pt-32pt">
      ...
      >
        ...
        <div class="row" role="tablist">
          <div class="col-auto">
            <a href="student-my-courses.html" class="btn btn-outline-secondary"
              >My Courses</a
            >
          </div>
        </div>
        ...
        <div class="row mb-lg-16pt">
          <div class="col-lg-6 mb-8pt mb-sm-0">
                  ...
                  <div class="flex">
                    <div class="d-flex align-items-center">
                      <div class="rounded mr-12pt z-0 o-hidden">
                        <div class="overlay">
                          <img
                            src="/images/paths/angular_40x40%402x.png"
                            width="40"
                            height="40"
                            alt="Angular"
                            class="rounded"
                          ...
                          <span
                            class="
                              overlay__content overlay__content-transparent
                            "
                          >
                            <span
                              class="
            ...
            <div class="popoverContainer d-none">
              ...
              <div class="my-32pt">
                ...
                <div class="d-flex align-items-center justify-content-center">
                  <a href="student-path.html" class="btn btn-primary mr-8pt"
                    >Resume</a
                  >
                  <a
                    href="student-path.html"
                  ...
                  <div class="flex">
                    <div class="d-flex align-items-center">
                      <div class="rounded mr-12pt z-0 o-hidden">
                        <div class="overlay">
                          <img
                            src="/images/paths/swift_40x40%402x.png"
                            width="40"
                            height="40"
                            alt="Angular"
                            class="rounded"
            ...
            <div class="popoverContainer d-none">
              ...
              <p class="mt-16pt text-70">
                Learn the fundamentals of working with Swift and how to create
                basic applications.
              </p>
                  ...
                  <div class="flex">
                    <div class="d-flex align-items-center">
                      <div class="rounded mr-12pt z-0 o-hidden">
                        <div class="overlay">
                          <img
                            src="/images/paths/react_40x40%402x.png"
                            width="40"
                            height="40"
                            alt="Angular"
                            class="rounded"
                ...
                <div class="mdk-carousel__content">
                  <div class="col-12 col-sm-6">
                    ...
                    >
                      ...
                      >
                        <img
                          src="/images/paths/angular_430x168.png"
                          alt="course"
                        />
                        <span
                          class="
                    ...
                    <div class="popoverContainer d-none">
                      ...
                      <div class="my-32pt">
                        ...
                        >
                          <div class="d-flex align-items-center mr-8pt">
                            <span
                              class="material-icons icon-16pt text-50 mr-4pt"
                              >access_time</span
                            >
                            <p class="flex text-50 lh-1 mb-0">
                              <small>50 minutes left</small>
                  ...
                  <div class="col-12 col-sm-6">
                    ...
                    >
                      ...
                      >
                        <img
                          src="/images/paths/swift_430x168.png"
                          alt="course"
                        />
                        <span
                          class="
                  ...
                  <div class="col-12 col-sm-6">
                    ...
                    >
                      ...
                      >
                        <img
                          src="/images/paths/wordpress_430x168.png"
                          alt="course"
                        />
                        <span
                          class="
                    ...
                    <div class="popoverContainer d-none">
                      <div class="media">
                        <div class="media-left mr-12pt">
                          <img
                            src="/images/paths/wordpress_40x40%402x.png"
                            width="40"
                            height="40"
                            alt="Angular"
                            class="rounded"
                  ...
                  <div class="col-12 col-sm-6">
                    ...
                    >
                      ...
                      >
                        <img
                          src="/images/paths/react_430x168.png"
                          alt="course"
                        />
                        <span
                          class="
            ...
            <div class="list-group-item p-3">
              <div class="row align-items-start">
                ...
                <div class="col mb-8pt mb-md-0">
                  <p class="mb-8pt">
                    <a href="discussion.html" class="text-body"
                      ><strong
                  ...
                  <a href="discussion.html" class="chip chip-outline-secondary"
            ...
            <div class="card card-group-row__card card-sm">
              <div class="card-body d-flex align-items-center">
                ...
                <div class="flex mr-12pt">
                  <a class="card-title" href="student-take-quiz.html"
              ...
              <div class="card-footer">
                <div class="d-flex align-items-center">
                  ...
                  <div class="dropdown">
                    ...
                    >
                    <div class="dropdown-menu dropdown-menu-right">
                      <a href="student-take-quiz.html" class="dropdown-item"
                        >Continue</a
                      >
                      <a
